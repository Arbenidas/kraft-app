...
abstract interface class ReminderPlatform {
  ...
  Future<void> schedule({required String id, required String title, required String body, required DateTime at});
  ...
  Future<String?> saveReminder({String? identifier, required String title, String notes, DateTime? at, bool done});
...
class ChannelReminderPlatform implements ReminderPlatform {
  ...
  @override
  Future<bool> authorizeNotifications() async => await _call<bool>('authorizeNotifications') ?? false;

  @override
  Future<void> schedule({required String id, required String title, required String body, required DateTime at}) =>
      _call<bool>('schedule', {'id': id, 'title': title, 'body': body, 'at': at.millisecondsSinceEpoch});

  @override
  Future<void> cancel(List<String> ids) => _call<void>('cancel', {'ids': ids});

  @override
  Future<bool> authorizeReminders() async => await _call<bool>('authorizeReminders') ?? false;

  @override
  Future<String?> saveReminder({String? identifier, required String title, String notes = '', DateTime? at, bool done = false}) =>
  ...
  @override
  Future<void> deleteReminder(String identifier) => _call<void>('deleteReminder', {'identifier': identifier});
}
